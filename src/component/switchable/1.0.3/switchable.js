define("plugin/jquery.easing.1.3", ["jquery"], function($) {
...
define("component/switchable/1.0.3/switchable", [ "jquery", "widget", "./plugins/effects", "./plugins/autoplay", "./plugins/circular", "easing"], function($, Widget, Effects, Autoplay, Circular) {
    // Switchable
    // -----------
