...
define("dist/router", ["$", "dist/history", "arale/events/1.1.0/events"], function($, history, Events) {
    ...
    var result = function(object, property) {
        ...
        return S.isFunction(value) ? value.call(object) : value;
    };
    ...
    $.extend(Router.prototype, {
        ...
        route: function(route, name, callback) {
            if (!S.isRegExp(route)) route = this._routeToRegExp(route);
        ...
        _bindRoutes: function() {
            ...
            var route, routes = S.keys(this.routes);
        ...
        _extractParameters: function(route, fragment) {
            ...
            return S.map(params, function(param, i) {
