tbtx.define("tip", ["drop"], function() {
    ...
    S.loadCss("base/css/component/tip.css");

    var BasicTip = new S.Class(Drop, {
        attrs: {
            // 提示内容
            content: null,
    ...
    BasicTip.outerBoxClass = "arale-tip-1_2_1";

    var Tip = new S.Class(BasicTip, {
        attrs: {
            template: Tpl,
            // 提示内容
            content: "A TIP BOX",
