...
define("component/validator/0.9.7/core", [ "jquery", "component/validator/0.9.7/async", "widget", "component/validator/0.9.7/utils", "component/validator/0.9.7/rule", "component/validator/0.9.7/item" ], function($, async, Widget, utils, Rule, Item) {
...
define("component/validator/0.9.7/item", [ "jquery", "component/validator/0.9.7/utils", "component/validator/0.9.7/rule", "widget", "component/validator/0.9.7/async" ], function($, utils, Rule, Widget, async) {
    var setterConfig = {
        value: $.noop,
        setter: function(val) {
            return $.isFunction(val) ? val : utils.helper(val);
